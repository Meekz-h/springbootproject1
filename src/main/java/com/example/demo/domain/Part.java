...
public abstract class Part implements Serializable {
    ...
    @Min(value = 0, message = "MinInv value must be positive")
    int minInv;

    @Min(value = 0, message = "MaxInv value must be positive")
    int maxInv;
    ...
    public boolean isInvValid(){ return (this.inv >= this.minInv && this.inv <= this.maxInv);}
